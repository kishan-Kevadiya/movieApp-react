...
<VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
    <Heading colorScheme={'purple'} borderBottom={'1px solid purple'}>HDR video</Heading>
    <Text>This is the video for anyine it can be a wave anything to string to between its just a reliablle with patel.</Text>
</VStack>
        </VStack>
...
<Button variant={'ghost'} colorScheme={'purple'} onClick={()=> setVideoSrc(item)}>Episode {index+1}</Button>
))
